      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1 mt-2">
            <img src={assets.starIcon} className="w-3 5" alt="" />
            <img src={assets.starIcon} className="w-3 5" alt="" />
            <img src={assets.starIcon} className="w-3 5" alt="" />
            <img src={assets.starIcon} className="w-3 5" alt="" />
            <img src={assets.starNullIcon} className="w-3 5" alt="" />
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  className={`border py-2 px-4 bg-gray-100 ${item === size ? "border" : "border-0"}`}
                >
                  {item}
                </button>
              ))}
          ...
          <div className="mt-20">
            ...
            <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
              <p>
                ...
                convinence, accessibility, and the global reach they offer.{" "}
              </p>
              <p>
                {" "}
                E-commerce websites typically display products or services along
                with detailed descriptions, images, prices, and any available
                variatios (e.g., sizes, colors). Each product usually has its
